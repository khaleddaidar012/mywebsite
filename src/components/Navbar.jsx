        ...
        <div className="container flex item-center justify-between "> 
            <a className="text-xl font-bold text-primary flex item-center" href="#hero">
                <span className="relative z-10">
                    <span className="text-glow text-foreground"> Khaled Portfolio</span>
                </span>
            </a>
            {/* desktop nav*/}
        <div className=" md:flex items-center gap-6 mr-20">
    {navItem.map((item, key) => (
    <a
        key={key}
        href={item.href}
        className="relative text-lg font-medium text-foreground/80 hover:text-primary transition-colors duration-300 px-3 py-1
